...
namespace Petzey.Appointments.Business
{
    class DTOMapper
    {
        ...
        public Appointment DTOToAppointment(IAppointmentRepository _repo, DTOAppointment dto)
        {
        ...
        public DTOAppointment AppointmentToDTO(IAppointmentRepository _repo, Appointment ap)
        {
